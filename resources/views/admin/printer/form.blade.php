<div class="col-md-4 {{ $errors->has('kode') ? 'has-error' : '' }}">
    ...
    <input type="text" id="kode" name="kode" class="form-control" value="{{ old('kode', isset($printer) ? $printer->kode : '') }}" placeholder="Cth: 001/L220/65">
    @if($errors->has('kode'))
    ...
    <p class="helper-block text-muted">
        ...
        *Masukan nomor terakhir IP CPU Klien
    </p>
</div>
...
<div class="col-md-4 {{ $errors->has('nama') ? 'has-error' : '' }}">
    ...
    @endif
    <p class="helper-block text-muted">
        *Masukan data klien yang akan memakai printer
    </p>
</div>
